...
const stylePlatforms = [
    {
        name: 'Spotify',
        url: 'https://open.spotify.com/track/1wdZFH8dbdUXQxTmoAh9tu?si=XFFQHBZJTEKNPC73dT5vhA',
        icon: (
    ...
    {
        name: 'Apple Music',
        url: 'https://music.apple.com/us/song/style/1861588094',
        icon: (
            <svg viewBox="0 0 24 24" fill="currentColor">
    ...
    {
        name: 'Amazon Music',
        url: 'https://music.amazon.com/albums/B0G76C8TSC?marketplaceId=ATVPDKIKX0DER&musicTerritory=US&ref=dm_sh_eTb0ZyVvrVMWngjwGtbGHdGHL',
        icon: (
            <svg viewBox="0 0 24 24" fill="currentColor">
                    ...
                    >
                        ...
                        <div className="style-modal__header">
                            <img
                                ...
                                alt="Style - Single Cover"
                                className="style-modal__cover"
                            />
                            <div className="style-modal__info">
                                <h2 className="style-modal__title">Style</h2>
                                <p className="style-modal__artist">TALI</p>
                            </div>
                        </div>
                        ...
                        <div className="style-modal__platforms">
                            {stylePlatforms.map((platform, index) => (
                                <motion.a
                                    key={platform.name}
                                    href={platform.url}
                                    target="_blank"
