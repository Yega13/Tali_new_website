...
J:"ytp-mdx-popup-dialog",D:{role:"dialog"},T:[{U:"div",J:"ytp-mdx-popup-dialog-inner-content",T:[{U:"div",J:"ytp-mdx-popup-title",G0:"\u0412\u044b \u0432\u044b\u0448\u043b\u0438 \u0438\u0437 \u0430\u043a\u043a\u0430\u0443\u043d\u0442\u0430"},{U:"div",J:"ytp-mdx-popup-description",G0:'\u0420\u043e\u043b\u0438\u043a\u0438, \u043a\u043e\u0442\u043e\u0440\u044b\u0435 \u0432\u044b \u043f\u043e\u0441\u043c\u043e\u0442\u0440\u0438\u0442\u0435, \u043c\u043e\u0433\u0443\u0442 \u0431\u044b\u0442\u044c \u0434\u043e\u0431\u0430\u0432\u043b\u0435\u043d\u044b \u0432 \u0438\u0441\u0442\u043e\u0440\u0438\u044e \u043f\u0440\u043e\u0441\u043c\u043e\u0442\u0440\u0430 \u043d\u0430 \u0442\u0435\u043b\u0435\u0432\u0438\u0437\u043e\u0440\u0435, \u0447\u0442\u043e \u0441\u043a\u0430\u0436\u0435\u0442\u0441\u044f \u043d\u0430 \u0440\u0435\u043a\u043e\u043c\u0435\u043d\u0434\u0430\u0446\u0438\u044f\u0445. \u0427\u0442\u043e\u0431\u044b \u044d\u0442\u043e\u0433\u043e \u0438\u0437\u0431\u0435\u0436\u0430\u0442\u044c, \u0432\u044b\u0431\u0435\u0440\u0438\u0442\u0435 "\u041e\u0442\u043c\u0435\u043d\u0430" \u0438 \u0432\u043e\u0439\u0434\u0438\u0442\u0435 \u0432 \u0430\u043a\u043a\u0430\u0443\u043d\u0442 \u043d\u0430 \u043a\u043e\u043c\u043f\u044c\u044e\u0442\u0435\u0440\u0435.'},
{U:"div",J:"ytp-mdx-privacy-popup-buttons",T:[{U:"button",UR:["ytp-button","ytp-mdx-privacy-popup-cancel"],G0:"\u041e\u0442\u043c\u0435\u043d\u0430"},{U:"button",UR:["ytp-button","ytp-mdx-privacy-popup-confirm"],G0:"\u041e\u041a"}]}]}]});this.fade=new g.Jd(this,250);this.cancelButton=this.Vc("ytp-mdx-privacy-popup-cancel");this.confirmButton=this.Vc("ytp-mdx-privacy-popup-confirm");g.Q(this,this.fade);this.K(this.cancelButton,"click",this.X);this.K(this.confirmButton,"click",this.B)},jN=function(m){g.d.call(this,
{U:"div",
J:"ytp-remote",T:[{U:"div",J:"ytp-remote-display-status",T:[{U:"div",J:"ytp-remote-display-status-icon",T:[g.kRB()]},{U:"div",J:"ytp-remote-display-status-text",G0:"{{statustext}}"}]}]});this.api=m;this.fade=new g.Jd(this,250);g.Q(this,this.fade);this.K(m,"presentingplayerstatechange",this.onStateChange);this.UM(m.getPlayerStateObject())},In=function(m,F){g.p9.call(this,"\u0412\u044b\u0431\u0435\u0440\u0438\u0442\u0435 \u0443\u0441\u0442\u0440\u043e\u0439\u0441\u0442\u0432\u043e \u0434\u043b\u044f \u043f\u0440\u043e\u0441\u043c\u043e\u0442\u0440\u0430",
1,m,F);
...
this.yP={key:hgC(),name:"\u042d\u0442\u043e\u0442 \u043a\u043e\u043c\u043f\u044c\u044e\u0442\u0435\u0440"};this.r9=null;this.subscriptions=[];this.YJ=this.PR=null;this.Al=[this.yP];this.HC=this.yP;this.wF=new g.aQ(64);this.u8=0;this.yg=-1;this.v3=!1;this.gs=this.VS=this.Bx=null;if(!g.Hs(this.player.C())&&!g.Z9(this.player.C())){m=this.player;var F=g.x5(m);F&&(F=F.eb())&&(F=new In(m,F),g.Q(this,F));F=new jN(m);g.Q(this,F);g.Jb(m,F.element,4);this.Bx=new Vd;g.Q(this,this.Bx);g.Jb(m,this.Bx.element,
4);this.v3=!!LL()}},Rn=function(m){m.VS&&(m.player.removeEventListener("presentingplayerstatechange",m.VS),m.VS=null)},YwN=function(m,F,L){m.wF=L;
...
break;case -1:this.gY(new g.aQ(64));break;case -1E3:this.gY(new g.aQ(128,{errorCode:"mdx.remoteerror",errorMessage:"\u0412\u0438\u0434\u0435\u043e \u043d\u0435\u0434\u043e\u0441\u0442\u0443\u043f\u043d\u043e \u0434\u043b\u044f \u0443\u0434\u0430\u043b\u0435\u043d\u043d\u043e\u0433\u043e \u0432\u043e\u0441\u043f\u0440\u043e\u0438\u0437\u0432\u0435\u0434\u0435\u043d\u0438\u044f.",vl:2}))}m=UB(this.PR).trackData;var F=this.V;(m||F?m&&F&&m.trackName==F.trackName&&m.languageCode==F.languageCode&&m.languageName==
F.languageName&&m.kind==F.kind:1)||(this.V=m,iom(this,m));m=UB(this.PR);m.volume===-1||Math.round(this.j.getVolume())===m.volume&&this.j.isMuted()===m.muted||this.hF.isActive()||this.Ja()}else eQ8(this)};
...
jN.prototype.UM=function(m){if(this.api.getPresentingPlayerType()===3){var F={RECEIVER_NAME:this.api.getOption("remote","currentReceiver").name};m=g.n(m,128)?g.L8('\u041e\u0448\u0438\u0431\u043a\u0430 \u043d\u0430 \u0443\u0441\u0442\u0440\u043e\u0439\u0441\u0442\u0432\u0435 "$RECEIVER_NAME"',F):m.isPlaying()||m.isPaused()?g.L8('\u0412\u043e\u0441\u043f\u0440\u043e\u0438\u0437\u0432\u0435\u0434\u0435\u043d\u0438\u0435 \u043d\u0430 \u0443\u0441\u0442\u0440\u043e\u0439\u0441\u0442\u0432\u0435 "$RECEIVER_NAME"',
F):g.L8('\u0423\u0441\u0442\u0430\u043d\u043e\u0432\u043b\u0435\u043d\u043e \u043f\u043e\u0434\u043a\u043b\u044e\u0447\u0435\u043d\u0438\u0435 \u043a \u0443\u0441\u0442\u0440\u043e\u0439\u0441\u0442\u0432\u0443 "$RECEIVER_NAME"',F);this.updateValue("statustext",m);this.fade.show()}else this.fade.hide()};g.Y(In,g.p9);In.prototype.B=function(){var m=this.j.getOption("remote","receivers");m&&m.length>1&&!this.j.getOption("remote","quickCast")?(this.Al=g.P5(m,this.X,this),this.fK(g.xZ(m,this.X)),m=this.j.getOption("remote","currentReceiver"),m=this.X(m),this.options[m]&&this.Kj(m),this.enable(!0)):this.enable(!1)};
In.prototype.X=function(m){return m.key};
In.prototype.Om=function(m){return m==="cast-selector-receiver"?"\u0414\u043e\u0431\u0430\u0432\u0438\u0442\u044c":this.Al[m].name};
